...
class $model;format="Camel"$ControllerSpec extends PlaySpec with GuiceOneAppPerTest with Injecting {
  ...
  "$model;format="Camel"$Controller GET" should {
    ...
    "render the createorlog page from a new instance of controller" in {
    ...
    "render the createorlog page from the application" in {
    ...
    "render the createorlog page from the router" in {
