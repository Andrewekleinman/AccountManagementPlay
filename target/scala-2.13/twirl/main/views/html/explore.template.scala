  ...
  <div class="wrapper doc">
    <article>
      ...
      <ul>
        ...
        <li>The action method used Twirl templates to render the <code>createorlog</code> page.</li>
      ...
      <p>
        <ol>
          ...
          <li>
            ...
            <p>The <code>Homecontroller</code> class includes the <code>createorlog</code> action method, as shown below.
              This is a very simple action method that generate an HTML page from the <code>createorlog.scala.html</code>
              Twirl template file.</p>
              <pre><code class="language-scala">def createorlog() = Action """),format.raw/*57.76*/("""{"""),format.raw/*57.77*/(""" """),format.raw/*57.78*/("""implicit request: Request[AnyContent] =>
...
"""),format.raw/*59.1*/("""}"""),format.raw/*59.2*/("""</code></pre>
          ...
          <li>To view the route that maps the browser request to the controller method, open the <code>conf/routes</code>
            ...
            <p>A route consists of an HTTP method, a path, and an action. This control over the URL schema makes it
              ...
              <code>/</code>
              to the <code>createorlog</code> action in <code>HomeController</code>:</p>
            <code>GET     /                           controllers.HomeController.createorlog</code></li>
          <li>Open <code>app/views/createorlog.scala.html</code> with your text editor.
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: a8befdd52e2035c65b5f535c75c0910c9aa90f6f
                  MATRIX: 724->1|820->3|850->8|877->27|916->29|944->32|991->71|1041->84|1071->88|4207->3197|4236->3204|4915->3855|4944->3856|4973->3857|5074->3931|5102->3932|6405->5208|6420->5214|6468->5240|6589->5335|6625->5350|6658->5356|6723->5391|6756->5394
